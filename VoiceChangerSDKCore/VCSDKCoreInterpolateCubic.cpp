...
VCSDKCoreInterpolateCubic::VCSDKCoreInterpolateCubic()
{
    fract = 0;
}


void VCSDKCoreInterpolateCubic::resetRegisters()
{
    fract = 0;
}
...
int VCSDKCoreInterpolateCubic::transposeMono(SAMPLETYPE *pdest,
...
/// updates "srcSamples" to amount of consumed source samples
int VCSDKCoreInterpolateCubic::transposeStereo(SAMPLETYPE *pdest,
                    const SAMPLETYPE *psrc,
                    int &srcSamples)
{
    int i;
...
/// updates "srcSamples" to amount of consumed source samples
int VCSDKCoreInterpolateCubic::transposeMulti(SAMPLETYPE *pdest,
                    const SAMPLETYPE *psrc,
                    int &srcSamples)
{
    int i;
